export default {
  ...
  'app.calendar.desc': 'View your symptoms day by day with colour coding. Spot good and bad periods at a glance.',
  'app.stool.title': 'Stool logging',
  'app.stool.desc': 'Bristol scale, blood, pain, fatigue, log everything in a few seconds.',
  'app.food.title': 'Meal diary',
  'app.food.desc': 'Record what you eat, meal by meal, to keep a concrete trail over the days.',
  'app.stats.title': 'Statistics',
  'app.stats.desc': 'Symptom curves, treatment start and stop dates on the same chart. See the evolution over weeks or months.',
  'app.meds.title': 'Profile and medications',
  'app.meds.desc': 'Enter your IBD type, current treatments and their start and end dates.',
  'app.correlations.title': 'Correlations',
  'app.correlations.desc': 'Cross-reference your meals and symptoms to find leads to explore with your doctor.',
  'app.langs.title': 'Multilingual',
  'app.langs.desc': 'The app is available in French and Spanish. More languages coming very soon.',
  'app.custom.title': 'Customisable',
  'app.custom.desc': 'Light or dark theme, notification settings, units and preferences tailored to your daily life.',
  'app.notifs.title': 'Notifications',
  'app.notifs.desc': 'Reminders so you don\'t forget to log your symptoms or meals.',
  'app.consult.title': 'Prepare my consultation',
  'app.consult.desc': 'Generate a PDF report with your clinical scores and history, ready to show your doctor.',
